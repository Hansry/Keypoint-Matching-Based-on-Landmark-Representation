...
parser.add_argument('-dt', "--dataset_type", type=str, default="UAcampus_gist", choices=["UAcampus_gist", "UAcampus", "Mapillary", "Mapillary_gist"], help='Potential loop closure dataset type')
...
parser.add_argument('-tp', "--true_positive_number", type=int, default=468, help='True positive image index of potential loop closure dataset')
parser.add_argument('-fp', "--false_positive_number", type=int, default=145, help='False positive image index of potential loop closure dataset')
